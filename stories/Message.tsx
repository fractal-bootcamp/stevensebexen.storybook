...
function getBorderRadius(isCurrentUser: boolean, messagePosition: MessagePosition): string {
  if (isCurrentUser) {
...
export function Message(props: MessageProps) {
  return (
    <div className={`flex gap-[23px] ${props.isCurrentUser ? 'flex-row' : 'flex-row-reverse'}`} style={{ width: props.width || 400 }}>
      ...
      <div className="px-[23px] py-[15px] min-w-0" style={{
        ...
        borderRadius: getBorderRadius(props.isCurrentUser, props.messagePosition)
      }}>
